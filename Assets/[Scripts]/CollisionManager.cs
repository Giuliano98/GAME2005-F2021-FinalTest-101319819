...
public class CollisionManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Check each sphere-2 against each AABB in the scene
    ...
    public static void CheckAABBs(CubeBehaviour a, CubeBehaviour b)
    {
            ...
            (a.min.z <= b.max.z && a.max.z >= b.min.z))
        {
            ...
            if (!a.contacts.Contains(contactB))
            {
                ...
                var aRigidBody = a.gameObject.GetComponent<RigidBody3D>();
                var bRigidBody = b.gameObject.GetComponent<RigidBody3D>();

                if (aRigidBody.GetBodyType() && !bRigidBody.GetBodyType())
                {
